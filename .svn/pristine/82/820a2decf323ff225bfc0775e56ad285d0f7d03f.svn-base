					...
					<li class="contents">
						...
						<div class="content">
							...
							<p class="Location">
								...
								<span class="btn_nav bold">관리자 모드</span> <span class="btn_nav bold">인원관리</span> <a href="../system/notice.do" class="btn_set refresh">새로고침</a>
							</p>
							<p class="conTitle">
							...
							<p>
								...
								<span class="fr">&nbsp;채용공고 기간&nbsp;	
									<input type="date" id="srcsdate"
