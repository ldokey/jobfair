...
.chatchat p.background {
    background: #f1f1f1;
    padding: 5px 10px;
}

.chatchat p.timestamp {
    font-size: 12px;
    color: #999;
    margin-right: 10px;
    padding-top: 6px;
    ...
    <div class="custom-card-header">${loginId}님의 채팅방 리스트</div>
...
<div class="custom-chat-modal" id="chatModal">
    <div class="container mt-5" id="happy" style="width: 700px;">
        <a href="" class="closePop"><span class="hidden">닫기</span></a>

        <div class="custom-chat-header">채팅방! ${loginId}님 어서오세요</div>
        <div class="custom-chat-body">
            <div class="chat-window" id="target"></div>
            <div class="d-flex justify-content-between">
                <input id="text" type="text" class="chat-input" />
                <button onclick="send();" class="chat-button">전송</button>
